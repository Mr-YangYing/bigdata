...
public class LaboratoryQueryObject extends QueryObject{
	...
	public void customizeQuery(){
		//学生的学号
		if (StringUtils.hasLength(labAddress)) {
			super.addQuery("labAddress like ?", "%" + labAddress + "%");
		}
		//增加关键字查询

      ...
      <div class="content col-md-10">
        ...
        <div class="container-fluid" style="border: 1px solid gainsboro;margin-bottom: 10px;height: 50px">
          <div class="row" style="padding-top: 8px">
            <div class="col-sm-7">
              <form class="form-inline" name="searchForm" action="${pageContext.request.contextPath}/student/list" method="post"><!--当屏幕小于768时，变为两行-->
              <!-- ---------------携带分页信息隐藏域 --------------------->
        ...
        <table class="table table-striped table-hover text-center table-bordered">
          ...
          <c:forEach items="${pageResult.listData}" var="student" varStatus="s">
	          <tr>
	            ...
	            <td>
	              <div class="btn-group">
	                <a class="" href="javascript:getStudentById('${student.id}')" style="margin-right: 20px">修改</a>
	                <a class="" href="javascript:deleteById('${student.id}')" >删除</a>
	              </div>
	            </td>
	          </tr>
          </c:forEach>
...
<div id="updateStudentDiv" style="display:none;overflow: hidden;padding-top: 60px">
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath}/student/update" method="post" name="updateForm">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<input type="text" name="studentNumber" class="form-control" value="" id="updateStudentNumber" placeholder="不能重复">
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-3 control-label">

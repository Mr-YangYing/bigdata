      ...
      <div class="content col-md-10">
        ...
        <div class="container-fluid" style="border: 1px solid gainsboro;margin-bottom: 10px;height: 50px">
          <div class="row" style="padding-top: 8px">
            <div class="col-sm-8">
              <form class="form-inline" name="searchForm" action="${pageContext.request.contextPath}/laboratory/list" method="post"><!--当屏幕小于768时，变为两行-->
              <!-- ---------------携带分页信息隐藏域 --------------------->
        ...
        <table class="table table-striped table-hover text-center table-bordered">
          ...
          <c:forEach items="${pageResult.listData}" var="laboratory" varStatus="s">
	          <tr>
	            ...
	            <td>
	              <div class="btn-group">
	                <a class="" href="javascript:getLaboratoryById(${laboratory.id})" style="margin-right: 20px">修改</a>
	                <a class="" href="javascript:deleteById(${laboratory.id})" >删除</a>
	              </div>
	            </td>
	          </tr>
          </c:forEach>

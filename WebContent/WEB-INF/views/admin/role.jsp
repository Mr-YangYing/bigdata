...
<!--             <th class="text-center">是否生成菜单</th>
          ...
          <c:forEach items="${pageResult.listData}" var="role" varStatus="r">
	          <tr>
	            ...
	            <td>
	              <div class="btn-group">
	                <a class="btn btn-warning btn-sm" href="javascript:getRoleById('${role.id}')" style="margin-right: 20px">修改</a>
	                <a class="btn btn-danger btn-sm" href="javascript:deleteById('${role.id}')" >删除</a>
	              </div>
	            </td>
	          </tr>
          </c:forEach>
